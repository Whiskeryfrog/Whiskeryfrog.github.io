...
const kakuna0 = new Pokemon(
    ...
    kakuna,
    bugPoison,
    "If caught as is, make sure to evolve this Pokémon as soon as possible."
);
...
const nidoranm0 = new Pokemon(
    ...
    nidoranm,
    poison,
    "In my opinion, the better Nidoran line, more attack based than the Nidoran♀ line."
);
...
const diglett0 = new Pokemon(
    ...
    diglett,
    ground,
    "A fast ground Pokémon that is good at what it does. Be mindful of its low HP though."
);
...
const bellsprout0 = new Pokemon(
    ...
    bellsprout,
    grassPoison,
    "An excellent grass type when fully evolved. You have many chances of getting this Pokémon if miss the chance."
);
